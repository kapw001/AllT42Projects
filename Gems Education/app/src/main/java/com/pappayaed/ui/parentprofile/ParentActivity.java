...
//    }
    ...
    private void init() {
        ...
        childAdapter = new RecyclerViewAdapter<>(Collections.EMPTY_LIST, R.layout.custom_child_profile_row);
        profileAdapter = new RecyclerViewAdapter<>(Collections.EMPTY_LIST, R.layout.custom_profile_row);
