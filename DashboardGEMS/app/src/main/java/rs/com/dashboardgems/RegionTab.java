...
// (0.02 + 0.45) * 2 + 0.06 = 1.00 -> interval per "group"
        ...
        List<String> xAxisLabels = new ArrayList<>(); //getSchoolName(list);
        xAxisLabels.add("UAE");
        xAxisLabels.add("INDIA");
        xAxisLabels.add("UK");
        xAxisLabels.add("FRANCE");
        xAxisLabels.add("USA");
...
//        int[] co = ColorTemplate.MATERIAL_COLORS;
    ...
    private List<Schools> getSchoolList() {
        ...
        list.add(new Schools("UAE", true, R.mipmap.ic_uaeflag, true));
        list.add(new Schools("INDIA", true, R.mipmap.ic_indiaflag, true));
        list.add(new Schools("UK", false, R.mipmap.ic_ukflag, true));
