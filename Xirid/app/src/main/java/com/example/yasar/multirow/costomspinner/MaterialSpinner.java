...
package com.example.yasar.multirow.costomspinner;
...
public class MaterialSpinner extends TextView {
    ...
    public MaterialSpinner(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        popupWindow.getBackground().setColorFilter(color, PorterDuff.Mode.SRC_IN);
    ...
    public void setDropdownWidth(int width) {
        ...
        popupWindow.setHeight(calculatePopupWindowWidth());
    }
    ...
    private int calculatePopupWindowWidth() {
        ...
        float listViewwidth = adapter.getCount() * getResources().getDimension(R.dimen.ms__item_width);
